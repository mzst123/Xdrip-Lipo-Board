...
I made an enclosure, however it still has to be improoved. To further reduce space, the JST-2 connector is not used in this design. In the future I might add one with JST-2 support. The battery compartment should fit an 850mah Lipo Battery. The .STL files are int the ["Enclosure"](https://github.com/mzst123/Xdrip-Lipo-Board/tree/master/Enclosure) Folder.
